...
export default function ServicesPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const published = json.filter((d: any) => d.published);
      setData(published);
    } catch (e) {
      console.error(e);
    } finally {
  ...
  const exportCSV = (cName: string, items: typeof filteredData) => {
    ...
    link.setAttribute('download', `${cName.replace(/\s+/g, '_')}_service_pages.csv`);
  ...
  return (
    <>
      <div className="page-title-section">
        ...
        <p className="page-subtitle">Browse imported programmatic pages by service, across every City/Community/County, Province and Category combination.</p>
      </div>
                    ...
                    <div className="empty-state">
                      ...
                      <div className="empty-state-text">
                        {searchQuery
                          ...
                          : 'Nothing published yet - import ready content on the Import page first.'}
                      </div>
                    </div>
                  </td>
                </tr>
